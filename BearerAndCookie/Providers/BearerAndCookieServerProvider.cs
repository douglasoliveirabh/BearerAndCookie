...
namespace BearerAndCookie.Providers
{
    public class BearerAndCookieServerProvider : OAuthAuthorizationServerProvider
    {

        private readonly string _publicClientId;        

        public BearerAndCookieServerProvider(string publicClientId)
        {
